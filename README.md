# 🌐 VandCloud - Simple Host Checking Made Easy
...
## ⚙️ How to Use VandCloud
Using VandCloud is simple. Here are the basic steps:

1. **Open the Application**: Click the VandCloud icon to open it.
2. **Enter Hostnames**: You can type in the URL or IP address of the host you want to check.
3. **Check Status**: Click the "Check" button. VandCloud will show if the host is online or offline.
